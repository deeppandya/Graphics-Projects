...
unsigned int Renderer::sShaderProgramID;
...
void Renderer::Initialize()
{
	...
	// Loading Shaders
	sShaderProgramID = LoadShaders("../Source/Shaders/vt.vertexshader", "../Source/Shaders/tessctrl.tesscontrolshader", "../Source/Shaders/tesseval.tessevalshader", "../Source/Shaders/geo.geometryshader", "../Source/Shaders/frag.fragmentshader");	
}

void Renderer::Shutdown()
{
	// Shaders
	glDeleteProgram(sShaderProgramID);
...
/* The following code is derived from www.opengl-tutorial.org*/
GLuint Renderer::LoadShaders(const char * vertex_file_path, const char * tessCtrl_file_path, const char * tessEval_file_path, const char * geometry_file_path, const char * fragment_file_path)
{
	// Create the shaders
	...
	// Read the tessalation control Shader code from the file
	std::string TessCtrlShaderCode;
	std::ifstream TessCtrlShaderStream(tessCtrl_file_path, std::ios::in);
	...
	// Read the tessalation evaluation Shader code from the file
	std::string TessEvalShaderCode;
	std::ifstream TessEvalShaderStream(tessEval_file_path, std::ios::in);
	...
	// Compile tessalation control Shader
	printf("Compiling shader : %s\n", tessCtrl_file_path);
	...
	// Check tessalation control Shader
	...
	// Compile tessalation evaluation Shader
	printf("Compiling shader : %s\n", tessEval_file_path);
